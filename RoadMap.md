...
- [x] **#19** `merged` flag never set `true` in `collapse_line` — double-merge prevention broken, `src/board.cpp`
- [x] **Display** `IMenuRenderer` interface — replace `display_menu` / `display_settings_menu` duplication
